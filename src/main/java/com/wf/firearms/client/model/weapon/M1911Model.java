...
public class M1911Model extends AbstractWeaponModel {
    ...
    private final LegacyModelRenderer m1911;
    ...
    public M1911Model() {
        ...
        m1911 = new LegacyModelRenderer(this);
    ...
    @Override
    public void renderWeapon(ItemStack stack, PoseStack matrix, VertexConsumer builder, int light, int overlay) {
