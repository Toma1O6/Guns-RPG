...
public class S686Model extends AbstractWeaponModel {
    ...
    private final LegacyModelRenderer barrels;
    ...
    private final LegacyModelRenderer bullet1;
...
public S686Model() {
        ...
        barrels = new LegacyModelRenderer(this);
        ...
        bullet1 = new LegacyModelRenderer(this);
        ...
        setSpecialRenderer(null, barrels);
        setSpecialRenderer(null, bullet1);
        setSpecialRenderer(null, bullet2);
    }
