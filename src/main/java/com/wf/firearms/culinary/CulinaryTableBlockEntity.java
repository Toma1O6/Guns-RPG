...
public class CulinaryTableBlockEntity extends BaseContainerBlockEntity implements Container {
    ...
    public CulinaryTableBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.CULINARY_TABLE.get(), pos, state);
    }
    ...
    public ItemStack previewFor(@Nullable Player player) {
        ...
        CulinaryRecipe recipe = findRecipe(level, this);
        if (recipe == null) {
            return ItemStack.EMPTY;
        }
    ...
    @Nullable
    public static CulinaryRecipe findRecipe(Level level, Container grid) {
        if (level == null) {
            return null;
        }
        for (CulinaryRecipe recipe : level.getRecipeManager().getAllRecipesFor(ModRecipeTypes.CULINARY.get())) {
    ...
    protected Component getDefaultName() {
        return Component.translatable("container.gunsrpg.culinary_table");
    }

    @Override
    protected AbstractContainerMenu createMenu(int id, Inventory inv) {
        return new CulinaryMenu(id, inv, this);
    }
