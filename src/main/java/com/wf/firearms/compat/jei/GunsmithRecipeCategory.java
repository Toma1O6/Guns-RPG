...
public class GunsmithRecipeCategory implements IRecipeCategory<GunsmithRecipe> {
    public static final ResourceLocation UID =
            ResourceLocation.fromNamespaceAndPath(GunsRpg.MOD_ID, "gunsmith");

    public static final RecipeType<GunsmithRecipe> RECIPE_TYPE =
            RecipeType.create(GunsRpg.MOD_ID, "gunsmith", GunsmithRecipe.class);
    ...
    public GunsmithRecipeCategory(IJeiHelpers helpers) {
        ...
        this.background = gui.createDrawable(
                ...
                29, 16, 116, 54);
        this.icon = gui.createDrawableItemStack(new ItemStack(ModBlocks.GUNSMITH_TABLE_ITEM.get()));
        this.title = Component.translatable("jei.gunsrpg.gunsmith");
    }

    @Override
    public RecipeType<GunsmithRecipe> getRecipeType() {
        return RECIPE_TYPE;
    }
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, GunsmithRecipe recipe, IFocusGroup focuses) {
