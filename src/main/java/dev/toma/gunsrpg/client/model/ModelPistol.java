...
public class ModelPistol extends ModelWeapon {
    ...
    public void doRender() {
        ...
        if(PlayerDataFactory.hasActiveSkill(player, Ability.PISTOL_SUPPRESSOR)) suppressor.render(1f);
    }
    ...
    public ModelPistol() {
        ...
        gunRenderer.setRotationPoint(0.0F, 24.0F, 0.0F);
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 69, 13, 0.6523F, -2.0742F, -10.0F, 1, 2, 9, 0.0F, false));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 69, 13, -1.6523F, -2.0742F, -10.0F, 1, 2, 9, 0.0F, true));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 69, 13, -0.9452F, -0.3671F, -10.0F, 1, 1, 9, 0.0F, true));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 69, 13, -0.0548F, -0.3671F, -10.0F, 1, 1, 9, 0.0F, false));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 69, 13, -2.0F, -0.975F, -1.0F, 4, 2, 3, 0.0F, false));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 69, 13, -1.0F, 4.6231F, 2.7321F, 2, 1, 7, 0.0F, false));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 69, 13, -1.5F, 1.025F, -0.5F, 3, 1, 1, 0.0F, false));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 69, 13, -1.5F, 1.5602F, -0.0508F, 3, 1, 1, 0.0F, false));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 85, 25, -2.0F, -0.9219F, 2.0F, 4, 1, 16, 0.0F, false));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 91, 22, -2.0F, 0.0781F, 8.625F, 4, 1, 7, 0.0F, false));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 91, 22, -2.0F, 1.0781F, 8.625F, 4, 1, 7, 0.0F, false));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 34, 40, -1.0F, -5.9F, -10.3516F, 2, 1, 11, 0.0F, false));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 35, 40, -1.0F, -5.9F, 0.6484F, 2, 1, 4, 0.0F, false));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 42, 45, 0.0F, -5.9F, 4.6484F, 1, 1, 7, 0.0F, false));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 13, 74, -0.8062F, -5.6688F, 4.6484F, 1, 1, 7, 0.0F, false));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 44, 48, -1.0F, -5.9F, 11.6484F, 2, 1, 7, 0.0F, false));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 3, 76, -1.5F, -6.318F, 16.6484F, 3, 1, 1, 0.0F, false));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 3, 76, 0.5F, -6.918F, 16.6484F, 1, 1, 1, 0.0F, false));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 3, 76, -1.5F, -6.918F, 16.6484F, 1, 1, 1, 0.0F, false));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 3, 76, -0.5F, -6.7867F, -9.7227F, 1, 1, 1, 0.0F, false));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 36, 40, -1.5F, -2.1679F, -10.3516F, 3, 2, 6, 0.0F, false));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 36, 40, -0.2071F, -0.4608F, -10.3516F, 1, 1, 10, 0.0F, false));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 36, 40, -0.7929F, -0.4608F, -10.3516F, 1, 1, 10, 0.0F, true));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 34, 38, -2.366F, -4.534F, -10.3516F, 1, 4, 11, 0.0F, false));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 35, 40, -2.366F, -4.534F, 0.6484F, 1, 4, 4, 0.0F, false));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 35, 40, -2.366F, -3.534F, 4.6484F, 1, 3, 7, 0.0F, false));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 13, 74, -2.1723F, -4.3027F, 4.6484F, 1, 1, 7, 0.0F, false));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 44, 48, -2.366F, -4.534F, 11.6484F, 1, 4, 7, 0.0F, false));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 42, 43, 0.2148F, -3.1956F, 18.748F, 1, 2, 1, 0.0F, false));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 42, 43, -1.2148F, -3.1956F, 18.748F, 1, 2, 1, 0.0F, true));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 42, 43, -0.7852F, -1.534F, 18.748F, 2, 1, 1, 0.0F, false));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 42, 43, -0.5F, -5.0082F, 17.9028F, 1, 1, 1, 0.0F, false));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 42, 43, -1.2148F, -1.534F, 18.748F, 1, 1, 1, 0.0F, true));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 50, 50, -1.5F, -3.534F, 18.1609F, 3, 3, 1, 0.0F, false));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 42, 43, -2.0F, -3.534F, 17.9297F, 4, 3, 1, 0.0F, false));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 42, 43, 1.366F, -4.534F, -10.3516F, 1, 4, 11, 0.0F, true));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 40, 9, -1.866F, -3.934F, -10.8516F, 1, 1, 1, 0.0F, false));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 40, 9, 0.866F, -3.934F, -10.8516F, 1, 1, 1, 0.0F, true));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 40, 9, -0.5F, -5.3F, -10.8516F, 1, 1, 1, 0.0F, false));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 40, 9, -0.5F, -2.5679F, -10.8516F, 1, 1, 1, 0.0F, false));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 42, 43, 1.366F, -4.534F, 0.6484F, 1, 4, 8, 0.0F, true));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 42, 43, 1.366F, -4.534F, 8.6484F, 1, 4, 5, 0.0F, true));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 43, 42, 1.366F, -4.534F, 13.6484F, 1, 4, 5, 0.0F, true));
        gunRenderer.cubeList.add(new ModelBox(gunRenderer, 12, 78, -1.0F, -4.5F, -10.4492F, 2, 2, 1, 0.0F, false));
        ...
        magazineRenderer.setRotationPoint(-1.5F, 45.0F, 0.0F);
        setRotationAngle(magazineRenderer, 0.1047F, 0.0F, 0.0F);
        magazineRenderer.cubeList.add(new ModelBox(magazineRenderer, 0, 69, 0.0F, -9.1594F, 10.1863F, 3, 2, 7, 0.0F, false));
        magazineRenderer.cubeList.add(new ModelBox(magazineRenderer, 0, 69, 0.0F, -20.1594F, 12.1863F, 3, 11, 5, 0.0F, false));
        magazineRenderer.cubeList.add(new ModelBox(magazineRenderer, 0, 69, 1.0F, -20.8594F, 16.0863F, 1, 1, 1, 0.0F, false));
        magazineRenderer.cubeList.add(new ModelBox(magazineRenderer, 8, 104, 1.0F, -21.4594F, 13.1863F, 1, 1, 3, 0.0F, false));
        magazineRenderer.cubeList.add(new ModelBox(magazineRenderer, 0, 69, 1.0F, -20.9594F, 12.4863F, 1, 1, 1, 0.0F, false));
        magazineRenderer.cubeList.add(new ModelBox(magazineRenderer, 0, 69, 2.0F, -21.1594F, 12.1863F, 1, 1, 5, 0.0F, false));
        magazineRenderer.cubeList.add(new ModelBox(magazineRenderer, 0, 69, 0.0F, -21.1594F, 12.1863F, 1, 1, 5, 0.0F, false));
        ...
        suppressor.setRotationPoint(0.0F, 21.0F, -28.0F);
