...
public class ModelSMG extends ModelWeapon {
    ...
    public void doRender() {
        ...
        sights.render(1f);
        barrel.render(1f);
        if(PlayerDataFactory.hasActiveSkill(player, Ability.SMG_SUPPRESSOR)) suppressor.render(1f);
        if(PlayerDataFactory.hasActiveSkill(player, Ability.SMG_RED_DOT)) rds.render(1f);
    }
