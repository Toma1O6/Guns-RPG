...
public class ZombieGunnerModel extends BipedModel<ZombieGunnerEntity> {

    public ZombieGunnerModel() {
        this(0.0F, false);
    }

    public ZombieGunnerModel(float modelSize, boolean isLayerModel) {
