...
public class ArTurretModel extends AbstractTurretModel {
    ...
    public ArTurretModel() {
        ...
        turret.addChild(gun);
        gun.texOffs(68, 70).addBox(-1.2F, -1.7813F, -22.3125F, 3.0F, 3.0F, 27.0F, 0.0F, false);
        gun.texOffs(68, 70).addBox(-1.7F, -2.2813F, -12.3125F, 4.0F, 4.0F, 15.0F, 0.0F, false);
