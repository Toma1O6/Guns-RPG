...
public class CriteriaTypes {
    ...
    private static final UnlockCriteria PISTOL_CRITERIA = new GunCriteria(() -> ModRegistry.GRPGItems.PISTOL);
    private static final UnlockCriteria SMG_CRITERIA = new GunCriteria(() -> ModRegistry.GRPGItems.SMG);
    private static final UnlockCriteria CROSSBOW_CRITERIA = new GunCriteria(() -> ModRegistry.GRPGItems.CROSSBOW);
    private static final UnlockCriteria SHOTGUN_CRITERIA = new GunCriteria(() -> ModRegistry.GRPGItems.SHOTGUN);
    private static final UnlockCriteria ASSALT_RIFLE_CRITERIA = new GunCriteria(() -> ModRegistry.GRPGItems.ASSAULT_RIFLE);
    private static final UnlockCriteria SNIPER_RIFLE_CRITERIA = new GunCriteria(() -> ModRegistry.GRPGItems.SNIPER_RIFLE);
