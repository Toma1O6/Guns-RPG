...
public class BulletEntity extends Entity {
    ...
    public BulletEntity(EntityType<? extends BulletEntity> type, World worldIn, LivingEntity shooter, GunItem gun, ItemStack stack) {
        this(type, worldIn);
        this.noPhysics = true;
        this.shooter = shooter;
        this.stack = stack;
        IWeaponConfig config = gun.getWeaponConfig();
        ...
        if (shooter instanceof PlayerEntity) {
            ...
            canPenetrateEntity = gun == ModItems.SNIPER_RIFLE && PlayerData.hasActiveSkill(player, Skills.SR_PENETRATOR);
        }
    }
    ...
    protected void onEntityHit(EntityRayTraceResult result) {
        ...
        if (!level.isClientSide) {
            ...
            boolean validWeaponForHeadshot = stack.getItem() == ModItems.SNIPER_RIFLE;
    ...
    public void tick() {
        ...
        if (tickCount > 2) {
            level.playSound(null, getX(), getY(), getZ(), ModSounds.BULLET_WHIZZ, SoundCategory.MASTER, 0.6F, 1.0F);
        }
