...
public class CommonRegistry {
    ...
    public static void onSkillRegister(RegistryEvent.Register<SkillType<?>> event) {
        event.getRegistry().registerAll(
                ...
                SkillType.Builder.<AttributeSkill>create(type -> new AttributeSkill(type, AttributeTarget.create(Modifiers.MK14_HEADSHOT, Attribs.MK14_HS_DAMAGE))).renderModIcon("dead_eye").build().setRegistryName("mk14ebr_dead_eye"),
                ...
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("hunter").build().setRegistryName("winchester_hunter"),
