...
public class CommonRegistry {
    ...
    public static void onSkillRegister(RegistryEvent.Register<SkillType<?>> event) {
        event.getRegistry().registerAll(
                ...
                SkillType.Builder.create(SimpleSkill::new).description(3).build().setRegistryName("m1911_heavy_bullets"),
                ...
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("quickdraw").description(0).build().setRegistryName("akm_quickdraw"),
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("extended").description(0).build().setRegistryName("akm_extended"),
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("suppressor").build().setRegistryName("akm_suppressor"),
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("red_dot").build().setRegistryName("akm_red_dot"),
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("tough_spring").description(0).build().setRegistryName("akm_tough_spring"),
