...
public class CommonRegistry {
    ...
    public static void onSkillRegister(RegistryEvent.Register<SkillType<?>> event) {
        event.getRegistry().registerAll(
                ...
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("bullet_loops").description(0).build().setRegistryName("winchester_bullet_loops"),
                ...
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("extended").description(0).build().setRegistryName("winchester_extended"),
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("fast_hands").description(0).build().setRegistryName("winchester_fast_hands"),
