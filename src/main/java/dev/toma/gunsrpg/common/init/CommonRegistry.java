...
public class CommonRegistry {
    ...
    public static void onSkillRegister(RegistryEvent.Register<SkillType<?>> event) {
        event.getRegistry().registerAll(
                ...
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("fast_hands").description(0).build().setRegistryName("grenade_launcher_fast_hands"),
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("gear_grinder").description(0).build().setRegistryName("grenade_launcher_gear_grinder"),
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("extended").description(0).build().setRegistryName("grenade_launcher_extended"),
                ...
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("quickdraw").description(0).build().setRegistryName("rocket_launcher_quickdraw"),
