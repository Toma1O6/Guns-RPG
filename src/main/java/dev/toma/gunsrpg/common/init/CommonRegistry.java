...
public class CommonRegistry {
    ...
    public static void onSkillRegister(RegistryEvent.Register<SkillType<?>> event) {
        event.getRegistry().registerAll(
                ...
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("reliable").build().setRegistryName("s686_reliable"),
                ...
                SkillType.Builder.<AttributeSkill>create(type -> new AttributeSkill(type, AttributeTarget.create(Modifiers.S12K_DRUM, Attribs.S12K_MAG_CAPACITY))).renderModIcon("extended").build().setRegistryName("s12k_extended_drum"),
                ...
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("heavy_bullets").build().setRegistryName("akm_heavy_bullets"),
                ...
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("reliable").build().setRegistryName("akm_reliable"),
                ...
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("reliable").build().setRegistryName("kar98k_reliable"),
