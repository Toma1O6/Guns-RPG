...
public class CommonRegistry {
    ...
    public static void onSkillRegister(RegistryEvent.Register<SkillType<?>> event) {
        event.getRegistry().registerAll(
                ...
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("quickdraw").description(0).build().setRegistryName("hk416_quickdraw"),
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("vertical_grip").build().setRegistryName("hk416_vertical"),
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("extended").description(0).build().setRegistryName("hk416_extended"),
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("red_dot").build().setRegistryName("hk416_red_dot"),
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("suppressor").build().setRegistryName("hk416_suppressor"),
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("extended_mk2").description(0).build().setRegistryName("hk416_extended_mk2"),
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("cheekpad").build().setRegistryName("hk416_cheekpad"),
