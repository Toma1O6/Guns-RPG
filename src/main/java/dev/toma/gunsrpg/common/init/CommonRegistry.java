...
public class CommonRegistry {
    ...
    public static void onSkillRegister(RegistryEvent.Register<SkillType<?>> event) {
        event.getRegistry().registerAll(
                ...
                SkillType.Builder.<AttributeSkill>create(type -> new AttributeSkill(type, AttributeSkill.IAttributeTarget.of(Attribs.WOODCUTTING_SPEED, Modifiers.CHOPPING_I))).description(SkillUtil.Localizations::localizeSharpAxeI).build().setRegistryName("sharp_axe_i"),
                SkillType.Builder.<AttributeSkill>create(type -> new AttributeSkill(type, AttributeSkill.IAttributeTarget.of(Attribs.WOODCUTTING_SPEED, Modifiers.CHOPPING_II))).description(SkillUtil.Localizations::localizeSharpAxeII).build().setRegistryName("sharp_axe_ii"),
                SkillType.Builder.<AttributeSkill>create(type -> new AttributeSkill(type, AttributeSkill.IAttributeTarget.of(Attribs.WOODCUTTING_SPEED, Modifiers.CHOPPING_III))).description(SkillUtil.Localizations::localizeSharpAxeIII).build().setRegistryName("sharp_axe_iii"),
                SkillType.Builder.<AttributeSkill>create(type -> new AttributeSkill(type, AttributeSkill.IAttributeTarget.of(Attribs.WOODCUTTING_SPEED, Modifiers.CHOPPING_IV))).description(SkillUtil.Localizations::localizeSharpAxeIV).build().setRegistryName("sharp_axe_iv"),
                SkillType.Builder.<AttributeSkill>create(type -> new AttributeSkill(type, AttributeSkill.IAttributeTarget.of(Attribs.WOODCUTTING_SPEED, Modifiers.CHOPPING_V))).description(SkillUtil.Localizations::localizeSharpAxeV).build().setRegistryName("sharp_axe_v"),
                ...
                SkillType.Builder.<AttributeSkill>create(type -> new AttributeSkill(type, AttributeSkill.IAttributeTarget.of(Attribs.DIGGING_SPEED, Modifiers.DIGGING_I))).description(SkillUtil.Localizations::localizeGraveDiggerI).build().setRegistryName("grave_digger_i"),
                SkillType.Builder.<AttributeSkill>create(type -> new AttributeSkill(type, AttributeSkill.IAttributeTarget.of(Attribs.DIGGING_SPEED, Modifiers.DIGGING_II))).description(SkillUtil.Localizations::localizeGraveDiggerII).build().setRegistryName("grave_digger_ii"),
                SkillType.Builder.<AttributeSkill>create(type -> new AttributeSkill(type, AttributeSkill.IAttributeTarget.of(Attribs.DIGGING_SPEED, Modifiers.DIGGING_III))).description(SkillUtil.Localizations::localizeGraveDiggerIII).build().setRegistryName("grave_digger_iii"),
                SkillType.Builder.<AttributeSkill>create(type -> new AttributeSkill(type, AttributeSkill.IAttributeTarget.of(Attribs.DIGGING_SPEED, Modifiers.DIGGING_IV))).description(SkillUtil.Localizations::localizeGraveDiggerIV).build().setRegistryName("grave_digger_iv"),
                SkillType.Builder.<AttributeSkill>create(type -> new AttributeSkill(type, AttributeSkill.IAttributeTarget.of(Attribs.DIGGING_SPEED, Modifiers.DIGGING_V))).description(SkillUtil.Localizations::localizeGraveDiggerV).build().setRegistryName("grave_digger_v"),
                SkillType.Builder.<AttributeSkill>create(type -> new AttributeSkill(type, AttributeSkill.IAttributeTarget.of(Attribs.MINING_SPEED, Modifiers.MINING_I))).description(SkillUtil.Localizations::localizeMiningI).build().setRegistryName("heavy_pickaxe_i"),
                SkillType.Builder.<AttributeSkill>create(type -> new AttributeSkill(type, AttributeSkill.IAttributeTarget.of(Attribs.MINING_SPEED, Modifiers.MINING_II))).description(SkillUtil.Localizations::localizeMiningII).build().setRegistryName("heavy_pickaxe_ii"),
                SkillType.Builder.<AttributeSkill>create(type -> new AttributeSkill(type, AttributeSkill.IAttributeTarget.of(Attribs.MINING_SPEED, Modifiers.MINING_III))).description(SkillUtil.Localizations::localizeMiningIII).build().setRegistryName("heavy_pickaxe_iii"),
                SkillType.Builder.<AttributeSkill>create(type -> new AttributeSkill(type, AttributeSkill.IAttributeTarget.of(Attribs.MINING_SPEED, Modifiers.MINING_IV))).description(SkillUtil.Localizations::localizeMiningIV).build().setRegistryName("heavy_pickaxe_iv"),
                SkillType.Builder.<AttributeSkill>create(type -> new AttributeSkill(type, AttributeSkill.IAttributeTarget.of(Attribs.MINING_SPEED, Modifiers.MINING_V))).description(SkillUtil.Localizations::localizeMiningV).build().setRegistryName("heavy_pickaxe_v"),
                ...
                SkillType.Builder.<SecondChanceSkill>create(type -> new SecondChanceSkill(type, Interval.minutes(15), 10, 0).setSurvivalCategory().setRegistryName("second_chance_i").descriptionLength(3).requiredLevel(50).price(7).childAndOverride(() -> Skills.SECOND_CHANCE_II).build(),
                SkillType.Builder.<SecondChanceSkill>create(type -> new SecondChanceSkill(type, Interval.minutes(12), 15, 1).setSurvivalCategory().setRegistryName("second_chance_ii").descriptionLength(3).requiredLevel(75).price(9).childAndOverride(() -> Skills.SECOND_CHANCE_III).build(),
                SkillType.Builder.<SecondChanceSkill>create(type -> new SecondChanceSkill(type, Interval.minutes( 9), 20, 2).setSurvivalCategory().setRegistryName("second_chance_iii").descriptionLength(3).requiredLevel(90).price(10).build(),
                ...
                SkillType.Builder.<LikeACatSkill>create(type -> new LikeACatSkill(type, Interval.minutes(5), Interval.minutes(2))).setSurvivalCategory().setRegistryName("like_a_cat_i").descriptionLength(2).requiredLevel(15).price(2).childAndOverride(() -> Skills.LIKE_A_CAT_II).build(),
                SkillType.Builder.<LikeACatSkill>create(type -> new LikeACatSkill(type, Interval.minutes(5), Interval.minutes(4))).setSurvivalCategory().setRegistryName("like_a_cat_ii").descriptionLength(2).requiredLevel(30).price(3).childAndOverride(() -> Skills.LIKE_A_CAT_III).build(),
                SkillType.Builder.<LikeACatSkill>create(type -> new LikeACatSkill(type, Interval.minutes(5), Interval.minutes(7))).setSurvivalCategory().setRegistryName("like_a_cat_iii").descriptionLength(2).requiredLevel(45).price(4).build(),
