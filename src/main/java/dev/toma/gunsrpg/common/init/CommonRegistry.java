...
public class CommonRegistry {
    ...
    public static void onSkillRegister(RegistryEvent.Register<SkillType<?>> event) {
        event.getRegistry().registerAll(
                ...
                SkillType.Builder.create(BasicSkill::new).build().setRegistryName("m1911_killing_spree"),
                ...
                SkillType.Builder.create(BasicSkill::new).renderModIcon("every_bullet_counts").build().setRegistryName("r45_every_bullet_counts"),
                ...
                SkillType.Builder.create(BasicSkill::new).renderModIcon("choke").build().setRegistryName("s1897_choke"),
                ...
                SkillType.Builder.create(BasicSkill::new).renderModIcon("extended_mk2").description(0).build().setRegistryName("hk416_extended_mk2"),
                ...
                SkillType.Builder.create(BasicSkill::new).renderModIcon("extended_mk2").description(0).build().setRegistryName("aug_extended_mk2"),
                ...
                SkillType.Builder.create(BasicSkill::new).renderModIcon("extended_mk2").build().setRegistryName("mk14ebr_extended_mk2"),
