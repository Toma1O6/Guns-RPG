...
public class CommonRegistry {
    ...
    public static void onSkillRegister(RegistryEvent.Register<SkillType<?>> event) {
        event.getRegistry().registerAll(
                ...
                SkillType.Builder.create(BasicSkill::new).description(0).build().setRegistryName("deagle_quickdraw"),
                SkillType.Builder.create(BasicSkill::new).description(0).build().setRegistryName("deagle_tough_spring"),
                SkillType.Builder.create(BasicSkill::new).build().setRegistryName("deagle_compensator"),
                SkillType.Builder.create(BasicSkill::new).description(0).build().setRegistryName("deagle_extended"),
                SkillType.Builder.create(BasicSkill::new).build().setRegistryName("deagle_red_dot"),
                SkillType.Builder.create(BasicSkill::new).build().setRegistryName("deagle_penetrator"),
