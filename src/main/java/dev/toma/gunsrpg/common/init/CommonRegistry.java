...
public class CommonRegistry {
    ...
    public static void onSkillRegister(RegistryEvent.Register<SkillType<?>> event) {
        event.getRegistry().registerAll(
                ...
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("quickdraw").description(0).build().setRegistryName("awm_quickdraw"),
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("scope").build().setRegistryName("awm_scope"),
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("extended").description(0).build().setRegistryName("awm_extended"),
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("cheekpad").build().setRegistryName("awm_cheekpad"),
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("suppressor").build().setRegistryName("awm_suppressor"),
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("fast_hands").description(0).build().setRegistryName("awm_fast_hands"),
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("penetrator").build().setRegistryName("awm_penetrator"),
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("dead_eye").build().setRegistryName("awm_dead_eye"),
