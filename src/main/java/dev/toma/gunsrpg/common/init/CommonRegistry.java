...
public class CommonRegistry {
    ...
    public static void onSkillRegister(RegistryEvent.Register<SkillType<?>> event) {
        event.getRegistry().registerAll(
                ...
                SkillType.Builder.create(BasicSkill::new).renderModIcon("repair_man").build().setRegistryName("repair_man_i"),
                SkillType.Builder.create(BasicSkill::new).renderModIcon("repair_man").build().setRegistryName("repair_man_ii"),
                SkillType.Builder.create(BasicSkill::new).renderModIcon("repair_man").build().setRegistryName("repair_man_iii"),
                SkillType.Builder.create(BasicSkill::new).renderModIcon("careful_gunner").build().setRegistryName("careful_gunner_i"),
                SkillType.Builder.create(BasicSkill::new).renderModIcon("careful_gunner").build().setRegistryName("careful_gunner_ii"),
                SkillType.Builder.create(BasicSkill::new).renderModIcon("careful_gunner").build().setRegistryName("careful_gunner_iii"),
                SkillType.Builder.create(BasicSkill::new).renderModIcon("lucky_shooter").build().setRegistryName("lucky_shooter_i"),
                SkillType.Builder.create(BasicSkill::new).renderModIcon("lucky_shooter").build().setRegistryName("lucky_shooter_ii"),
                SkillType.Builder.create(BasicSkill::new).renderModIcon("lucky_shooter").build().setRegistryName("lucky_shooter_iii"),
                ...
                SkillType.Builder.<BartenderSkill>create(type -> new BartenderSkill(type, 1)).description(0).renderModIcon("bartender").build().setRegistryName("bartender_i"),
                SkillType.Builder.<BartenderSkill>create(type -> new BartenderSkill(type, 2)).description(0).renderModIcon("bartender").build().setRegistryName("bartender_ii"),
                SkillType.Builder.<BartenderSkill>create(type -> new BartenderSkill(type, 3)).description(0).renderModIcon("bartender").build().setRegistryName("bartender_iii"),
                SkillType.Builder.<BartenderSkill>create(type -> new BartenderSkill(type, 4)).description(0).renderModIcon("bartender").build().setRegistryName("bartender_iv"),
                SkillType.Builder.<BartenderSkill>create(type -> new BartenderSkill(type, 5)).renderModIcon("bartender").build().setRegistryName("bartender_v"),
                ...
                SkillType.Builder.create(BasicSkill::new).build().setRegistryName("deagle_compensator"),
                ...
                SkillType.Builder.create(BasicSkill::new).build().setRegistryName("vector_overloaded"),
                ...
                SkillType.Builder.create(BasicSkill::new).description(1).build().setRegistryName("crossbow_tough_bowstring"),
                ...
                SkillType.Builder.create(BasicSkill::new).description(0).build().setRegistryName("chukonu_gear_grinder"),
                ...
                SkillType.Builder.create(BasicSkill::new).description(2).build().setRegistryName("s686_hunter"),
                SkillType.Builder.create(BasicSkill::new).build().setRegistryName("s686_choke"),
                ...
                SkillType.Builder.create(BasicSkill::new).build().setRegistryName("s686_extended_barrel"),
                SkillType.Builder.create(BasicSkill::new).build().setRegistryName("s12k_quickdraw"),
                SkillType.Builder.create(BasicSkill::new).build().setRegistryName("s12k_cheekpad"),
                SkillType.Builder.create(BasicSkill::new).build().setRegistryName("s12k_choke"),
                SkillType.Builder.create(BasicSkill::new).build().setRegistryName("s12k_never_give_up"),
                SkillType.Builder.create(BasicSkill::new).build().setRegistryName("s12k_tough_spring"),
                SkillType.Builder.create(BasicSkill::new).build().setRegistryName("s12k_red_dot"),
                SkillType.Builder.create(BasicSkill::new).build().setRegistryName("s12k_suppressor"),
                SkillType.Builder.create(BasicSkill::new).build().setRegistryName("s12k_extended_drum"),
                ...
                SkillType.Builder.create(BasicSkill::new).build().setRegistryName("akm_every_bullet_counts"),
                ...
                SkillType.Builder.create(BasicSkill::new).build().setRegistryName("hk416_overloaded"),
