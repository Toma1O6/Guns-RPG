...
public class CommonRegistry {
    ...
    public static void onSkillRegister(RegistryEvent.Register<SkillType<?>> event) {
        event.getRegistry().registerAll(
                ...
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("quickdraw").description(0).build().setRegistryName("mk14ebr_quickdraw"),
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("vertical_grip").build().setRegistryName("mk14ebr_vertical"),
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("extended").description(0).build().setRegistryName("mk14ebr_extended"),
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("tough_spring").description(0).build().setRegistryName("mk14ebr_tough_spring"),
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("cheekpad").build().setRegistryName("mk14ebr_cheekpad"),
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("scope").build().setRegistryName("mk14ebr_scope"),
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("suppressor").build().setRegistryName("mk14ebr_suppressor"),
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("dead_eye").build().setRegistryName("mk14ebr_dead_eye"),
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("extended_mk2").build().setRegistryName("mk14ebr_extended_mk2"),
