...
public class CommonRegistry {
    ...
    public static void onSkillRegister(RegistryEvent.Register<SkillType<?>> event) {
        event.getRegistry().registerAll(
                ...
                SkillType.Builder.<AttributeSkill>create(type -> new AttributeSkill(type, AttributeTarget.create(Modifiers.ACROBATICS_FALL_I, Attribs.FALL_RESISTANCE), AttributeTarget.create(Modifiers.ACROBATICS_EXPLOSION_I, Attribs.EXPLOSION_RESISTANCE))).description(0).build().setRegistryName("acrobatics_i"),
                SkillType.Builder.<AttributeSkill>create(type -> new AttributeSkill(type, AttributeTarget.create(Modifiers.ACROBATICS_FALL_II, Attribs.FALL_RESISTANCE), AttributeTarget.create(Modifiers.ACROBATICS_EXPLOSION_II, Attribs.EXPLOSION_RESISTANCE))).description(0).build().setRegistryName("acrobatics_ii"),
                SkillType.Builder.<AttributeSkill>create(type -> new AttributeSkill(type, AttributeTarget.create(Modifiers.ACROBATICS_FALL_III, Attribs.FALL_RESISTANCE), AttributeTarget.create(Modifiers.ACROBATICS_EXPLOSION_III, Attribs.EXPLOSION_RESISTANCE))).description(0).build().setRegistryName("acrobatics_iii"),
                ...
                SkillType.Builder.<AttributeSkill>create(type -> new AttributeSkill(type, AttributeTarget.create(Modifiers.TOUGH_SPRING, Attribs.UMP45_FIRERATE))).renderModIcon("tough_spring").build().setRegistryName("ump45_tough_spring"),
                ...
                SkillType.Builder.<AttributeSkill>create(type -> new AttributeSkill(type, AttributeTarget.create(Modifiers.CROSSBOW_QUIVER, Attribs.CROSSBOW_RELOAD_SPEED))).build().setRegistryName("crossbow_quiver"),
                ...
                SkillType.Builder.<AttributeSkill>create(type -> new AttributeSkill(type, AttributeTarget.create(Modifiers.CROSSBOW_EXTENDED, Attribs.CROSSBOW_MAG_CAPACITY), AttributeTarget.create(Modifiers.CROSSBOW_REPEATER, Attribs.CROSSBOW_RELOAD_SPEED))).build().setRegistryName("crossbow_repeater"),
                SkillType.Builder.<AttributeSkill>create(type -> new AttributeSkill(type, AttributeTarget.create(Modifiers.BULLET_LOOPS, Attribs.S1897_RELOAD_SPEED))).build().setRegistryName("s1897_bullet_loops"),
                SkillType.Builder.<AttributeSkill>create(type -> new AttributeSkill(type, AttributeTarget.create(Modifiers.S1897_EXTENDED, Attribs.S1897_MAG_CAPACITY))).renderModIcon("extended").build().setRegistryName("s1897_extended"),
                SkillType.Builder.<AttributeSkill>create(type -> new AttributeSkill(type, AttributeTarget.create(Modifiers.S1897_FAST_PUMP, Attribs.S1897_FIRERATE))).build().setRegistryName("s1897_pump_in_action"),
