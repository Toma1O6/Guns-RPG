...
public class CommonRegistry {
    ...
    public static void onSkillRegister(RegistryEvent.Register<SkillType<?>> event) {
        event.getRegistry().registerAll(
                ...
                SkillType.Builder.<AttributeSkill>create(type -> new AttributeSkill(type, AttributeTarget.createMany(Modifiers.DUAL_WIELD, Attribs.R45_FAST_HANDS, Attribs.R45_MAG_CAPACITY))).renderModIcon("dual_wield").description(SkillUtil.Localizations::generateSimpleDescription).build().setRegistryName("r45_dual_wield"),
