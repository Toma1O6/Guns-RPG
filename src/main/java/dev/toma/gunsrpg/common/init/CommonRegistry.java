...
public class CommonRegistry {
    ...
    public static void onItemRegister(RegistryEvent.Register<Item> event) {
        ...
        registry.registerAll(
                ...
                BaseItem.simpleItem("netherite_9mm_pack", properties -> properties.stacksTo(16)),
                BaseItem.simpleItem("netherite_12g_pack", properties -> properties.stacksTo(16)),
                BaseItem.simpleItem("netherite_45acp_pack", properties -> properties.stacksTo(16)),
                BaseItem.simpleItem("netherite_556mm_pack", properties -> properties.stacksTo(16)),
                BaseItem.simpleItem("netherite_762mm_pack", properties -> properties.stacksTo(16)),
                BaseItem.simpleItem("netherite_arrowhead"),
                BaseItem.simpleItem("netherite_bolts_quiver", properties -> properties.stacksTo(16)),
                BaseItem.simpleItem("netherite_buckshot"),
                BaseItem.simpleItem("netherite_bullet_tip"),
