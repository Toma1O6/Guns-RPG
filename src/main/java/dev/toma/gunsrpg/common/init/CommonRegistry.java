...
public class CommonRegistry {
    ...
    public static void onSkillRegister(RegistryEvent.Register<SkillType<?>> event) {
        event.getRegistry().registerAll(
                ...
                SkillType.Builder.<AttributeSkill>create(type -> new AttributeSkill(type, AttributeTarget.create(Modifiers.JAMMING_I, Attribs.JAM_CHANCE))).description(0).build().setRegistryName("lucky_shooter_i"),
                SkillType.Builder.<AttributeSkill>create(type -> new AttributeSkill(type, AttributeTarget.create(Modifiers.JAMMING_II, Attribs.JAM_CHANCE))).description(0).build().setRegistryName("lucky_shooter_ii"),
                SkillType.Builder.<AttributeSkill>create(type -> new AttributeSkill(type, AttributeTarget.create(Modifiers.JAMMING_III, Attribs.JAM_CHANCE))).description(0).build().setRegistryName("lucky_shooter_iii"),
