...
public class CommonRegistry {
    ...
    public static void onSkillRegister(RegistryEvent.Register<SkillType<?>> event) {
        event.getRegistry().registerAll(
                ...
                SkillType.Builder.<AttributeSkill>create(type -> new AttributeSkill(type, AttributeTarget.createMany(Modifiers.CARBON_BARREL, Attribs.DEAGLE_HORIZONTAL_RECOIL, Attribs.DEAGLE_VERTICAL_RECOIL))).renderModIcon("compensator").build().setRegistryName("deagle_compensator"),
                ...
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("quickdraw").description(0).build().setRegistryName("aug_quickdraw"),
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("extended").description(0).build().setRegistryName("aug_extended"),
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("vertical_grip").build().setRegistryName("aug_vertical"),
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("compensator").build().setRegistryName("aug_compensator"),
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("red_dot").build().setRegistryName("aug_red_dot"),
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("suppressor").build().setRegistryName("aug_suppressor"),
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("extended_mk2").description(0).build().setRegistryName("aug_extended_mk2"),
