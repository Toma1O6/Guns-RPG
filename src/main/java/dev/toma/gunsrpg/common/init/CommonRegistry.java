...
public class CommonRegistry {
    ...
    public static void onSkillRegister(RegistryEvent.Register<SkillType<?>> event) {
        event.getRegistry().registerAll(
                ...
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("quickdraw").description(0).build().setRegistryName("vss_quickdraw"),
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("scope").build().setRegistryName("vss_scope"),
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("cheekpad").build().setRegistryName("vss_cheekpad"),
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("extended").description(0).build().setRegistryName("vss_extended"),
                SkillType.Builder.create(SimpleSkill::new).renderModIcon("adaptive_chambering").build().setRegistryName("vss_adaptive_chambering"),
