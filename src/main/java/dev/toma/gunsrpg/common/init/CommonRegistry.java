...
public class CommonRegistry {
    ...
    public static void onSkillRegister(RegistryEvent.Register<SkillType<?>> event) {
        event.getRegistry().registerAll(
                ...
                SkillType.Builder.<AttributeSkill>create(type -> new AttributeSkill(type, AttributeTarget.create(Modifiers.DUAL_WIELD, Attribs.M1911_MAG_CAPACITY, Attribs.M1911_RELOAD_SPEED))).renderModIcon("dual_wield").description(SkillUtil.Localizations::generateSimpleDescription).build().setRegistryName("m1911_dual_wield"),
