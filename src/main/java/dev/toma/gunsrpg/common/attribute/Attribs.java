...
public final class Attribs {
    ...
    public static final IAttributeId UMP45_VERTICAL_RECOIL      = createInternal("ump45_vertical_recoil", 1.1);
    ...
    public static final IAttributeId THOMPSON_VERTICAL_RECOIL   = createInternal("thompson_vertical_recoil", 1.3);
    ...
    public static final IAttributeId VECTOR_VERTICAL_RECOIL     = createInternal("vector_vertical_recoil", 0.2);
    ...
    public static final IAttributeId HK416_VERTICAL_RECOIL      = createInternal("hk416_vertical_recoil", 0.7);
    public static final IAttributeId HK416_HORIZONTAL_RECOIL    = createInternal("hk416_horizontal_recoil", 0.4);
    ...
    public static final IAttributeId AUG_VERTICAL_RECOIL        = createInternal("aug_vertical_recoil", 1.35);
    ...
    public static final IAttributeId SKS_VERTICAL_RECOIL        = createInternal("sks_vertical_recoil", 3.0);
    ...
    public static final IAttributeId VSS_VERTICAL_RECOIL        = createInternal("vss_vertical_recoil", 0.8);
    public static final IAttributeId VSS_HORIZONTAL_RECOIL      = createInternal("vss_horizontal_recoil", 0.4);
    ...
    public static final IAttributeId MK14_VERTICAL_RECOIL       = createInternal("mk14_vertical_recoil", 2.1);
    public static final IAttributeId MK14_HORIZONTAL_RECOIL     = createInternal("mk14_horizontal_recoil", 1.7);
    ...
    public static final IAttributeId AWM_VERTICAL_RECOIL        = createInternal("awm_vertical_recoil", 1);
    public static final IAttributeId AWM_HORIZONTAL_RECOIL      = createInternal("awm_horizontal_recoil", 1);
