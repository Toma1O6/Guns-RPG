...
public class CrystalFusionStationBlock extends BaseBlock {

    private static final ITextComponent TITLE = new TranslationTextComponent("screen.crystal_fusion_station");

    public CrystalFusionStationBlock(String name) {
    ...
    public INamedContainerProvider getMenuProvider(BlockState state, World world, BlockPos pos) {
        return new SimpleNamedContainerProvider((windowId, inventory, player) -> new CrystalFusionStationContainer(windowId, inventory, (CrystalFusionStationTileEntity) world.getBlockEntity(pos)), TITLE);
    }
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new CrystalFusionStationTileEntity();
    }
}
