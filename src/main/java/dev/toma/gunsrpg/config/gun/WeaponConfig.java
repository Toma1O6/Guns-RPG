...
public class WeaponConfig {
    ...
    public WeaponConfiguration pistol = new WeaponConfiguration("Pistol", 3.0F, 14.0F, 3, 1.2F, 2.3F);
    public WeaponConfiguration smg = new WeaponConfiguration("SMG", 2.0F, 16.0F, 5, 0.7F, 1.6F);
