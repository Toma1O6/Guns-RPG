...
public class Keyframes {
    ...
    public static Vector4f getInitialRotation(IKeyframe parent) {
        Vector4f v1 = parent.initialRotation();
        Vector4f v2 = parent.relativeRot();
        return v1.add(v2);
    }
    ...
    public static Vector4f getRelativeRotation(Vector4f target, Vector4f initial) {
        return target.subtract(initial);
    }
    ...
    public static IKeyframe keyframe(Vector3d position, Vector4f rotation, float endpoint) {
